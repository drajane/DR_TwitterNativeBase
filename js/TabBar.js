...
import NotificationsHeader from './components/home/NotificationsHeader';
import MessagesHeader from './components/home/MessagesHeader';
...
onButtonPress(tabKey) {    
  ...
  render () {
    ...
    if (!!this.state.searchActive) {
      ...
      if (routes.key=='Message') {        
        header=<MessagesHeader navigation={navigation}/>;
      }
      else if (routes.key=='Notif') {
        header=<NotificationsHeader navigation={navigation}/>;
      }
      else{
